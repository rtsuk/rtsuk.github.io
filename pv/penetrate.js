...
(function() {
  var calculate, calculateOne, getBooleanValue, getIntValue, lineChartData, randomInt, roll, showChart;
  ...
  calculateOne = function(attackDice, crits, hits, defenseDice, shields, firepower, armor, cancelCrits) {
    var attackRoll, critCount, defenseRoll, hitCount, i, penetrate, result, _i, _j;
    critCount = 0;
    hitCount = 0;
    penetrate = false;
  ...
  calculate = function() {
    var armor, attackDice, cancelCritsFirst, critSides, defenseDice, firepower, hit, hitCount, hitSides, i, iterations, penetrate, penetrateCount, shields, _i, _j, _ref;
    ...
    for (armor = _i = 1; _i < 20; armor = ++_i) {
      ...
      for (i = _j = 1; _j <= iterations; i = _j += 1) {
        _ref = calculateOne(attackDice, hitSides, critSides, defenseDice, shields, firepower, armor, cancelCritsFirst), hit = _ref.hit, penetrate = _ref.penetrate;
        if (hit) {
          hitCount += 1;
        }
        if (penetrate) {
